...
class APIService:
    ...
    def download_csv(self, dataset_id: int, save_path: str) -> Dict[str, Any]:
        """Download CSV export for a dataset."""
        url = f"{self.base_url}/datasets/{dataset_id}/csv/"
        headers = self._get_headers()
        headers.pop("Content-Type", None)
    ...
    def get_equipment_list(self, dataset_id: int, start_date: str = None, end_date: str = None) -> Dict[str, Any]:
        ...
        url = f"{self.base_url}/datasets/{dataset_id}/equipment/"
        headers = self._get_headers()
    ...
    def add_equipment(self, dataset_id: int, equipment_data: Dict) -> Dict[str, Any]:
        """Add new equipment to a dataset."""
        response = self._make_request(
            "POST",
            f"/datasets/{dataset_id}/equipment/add/",
        ...
        if response.status_code in [200, 201]:
            ...
            return {"success": False, "error": response.json().get("error", "Failed to add equipment")}
    
    def update_equipment(self, dataset_id: int, equipment_id: int, equipment_data: Dict) -> Dict[str, Any]:
        """Update an existing equipment."""
        response = self._make_request(
            "PUT",
            f"/datasets/{dataset_id}/equipment/{equipment_id}/",
            json_data=equipment_data
        )
        ...
        if response.status_code == 200:
            ...
            return {"success": False, "error": response.json().get("error", "Failed to update equipment")}
    
    def delete_equipment(self, dataset_id: int, equipment_id: int) -> Dict[str, Any]:
        """Delete an equipment from a dataset."""
        response = self._make_request(
            "DELETE",
            f"/datasets/{dataset_id}/equipment/{equipment_id}/"
        )
